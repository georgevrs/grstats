"""
Complete Parsing Test Script
Tests the full pipeline: analysis -> parsing -> SDMX format
"""
...
def main():
    """Main function to test the complete parsing pipeline"""
    ...
    print(f"Testing complete parsing pipeline for sheet '{sheet_name}' from file '{file_path}'")
    print("="*80)
    ...
    try:
        ...
        print(f"\nParsed data sample (first 3 records):")
        ...
        # Save template
        template_file = "assets/prepared/lfs_popul_regio_template.xlsx"
        ...
        print(f"ERROR during complete parsing: {e}")
        import traceback
        traceback.print_exc()
